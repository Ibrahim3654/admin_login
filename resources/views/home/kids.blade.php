...
<body>
    ...
    <div class="watches-header">
        <h1>KIDS SECTIONS</h1>
        <p>A delightful fusion of comfort, durability, and style, our kids’ clothing collection is designed to keep up with every adventure, while bringing joy to every moment.<a href="#">Read more</a></p>
...
<section class="hero-section">
    <img src="{{ asset('images/kids.jpg')}}" alt="Luxury Watch">
    <div class="caption">
...
<section class="hero-section">
    ...
    <img src="{{ asset('images/boys1.avif')}}" alt="Stylish Watch">
</section>


<section class="product-grid">
    <div class="product">
        <img src="{{ asset('images/girls.avif')}}" alt="Watch 1">  
    ...
    <div class="product">
        <img src="{{ asset('images/girls3.avif')}}" alt="Watch 2">
    ...
    <div class="product">
        <img src="{{ asset('images/boys2.webp')}}" alt="Watch 3">
    ...
    <div class="product">
        <img src="{{ asset('images/boys1.avif')}}" alt="Watch 4">
    ...
    <div class="product">
        <img src="{{ asset('images/girls.avif')}}" alt="Watch 5">
